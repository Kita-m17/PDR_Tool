...
public class TraceStep {
     ...
     */
    public TraceStep(int iteration, KnowledgeBase consideredFormulas, List<ExceptionalityCheck> checks, KnowledgeBase assignedRank, KnowledgeBase carriedForward) {
